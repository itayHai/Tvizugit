        ...
        <div>
            <section className={classes.section}>
                <div className={classes.text}>
                    <Typography className={classes.headLine} variant="h4">נפגעת? חלית? אולי מגיעים לך פיצויים מתביעה ייצוגית!</Typography>
            ...
            <article className={classes.article}>
                <p className={classes.classActionTitle}>
                    התובענות הבולטות ביותר
                </p>
